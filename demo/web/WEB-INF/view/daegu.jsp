...
<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    ...
    <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        ...
        <div>
            <img src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMjAyMDZfOTAg%2FMDAxNjQ0MTM4NzQ2MjYz.BZRI4db7DzvP-M4X1IdbYOlwQLyh1BxIfgPwaaHt640g.WCLL0wBVB-0QvaJtND6lvH-PDBo7HrA0yGvq_l2YGF4g.JPEG.kkyoon77%2F20220206%25A3%25DF071717.jpg&type=sc960_832"
                 class="tower">
        </div>
    </div>
</div>
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        ...
        <div>
            <img src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTAyMjZfMjAy%2FMDAxNjE0MzQ3MDEzNzY3.JtGUGICPempQpJi0Y7PsjKGSiKuP9CqjvKkIaZVVhZog.NqYoN-1iPg9DkVQJsTKkAF5khkBm9HW44OaMDCOBnmEg.JPEG.anabella1129%2FKakaoTalk_20210226_213028348_01.jpg%234160x3120"
                 class="town">
        </div>
    </div>
    <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
        ...
        <div>
            <img src="https://tour.daegu.go.kr/icms/tour/file/getImage.do?atchFileId=FILE_KOATTR_226%20%20%20%20%20&fileSn=1"
                 class="lotte">
        </div>
    </div>
</div>
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
        ...
        <div>
            <img src="https://tour.daegu.go.kr/icms/tour/file/getImage.do?atchFileId=FILE_KOATTR_221%20%20%20%20%20&fileSn=3"
                 class="river">
        </div>
    </div>
    <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        <div class="my-3 py-3">
            ...
            <p class="lead">대구 최대의 상설시장, 야시장도 인기. 조선시대 평양장, 강경장과 함께 전국 3대 장터의<br> 하나로 이름 떨친 전통시장, 건해산물상가, 아진상가 등
                8개 지구로 구성되고,<br> 약 5,522여 개의 점포가 들어서 있다. 주 거래품목인 주단, 모목 등을<br> 비롯해 그릇, 청과, 건어물, 해산물 등 다양한 상품이 거래되는 큰
                시장이다.</p>
        </div>
        <div>
            <img src="https://tour.daegu.go.kr/icms/tour/file/getImage.do?atchFileId=FILE_KOATTR_229%20%20%20%20%20&fileSn=3725"
                 class="market">
        </div>
    </div>
</div>
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        ...
        <div>
            <img src="https://tour.daegu.go.kr/icms/tour/file/getImage.do?atchFileId=FILE_KOATTR_328%20%20%20%20%20&fileSn=3515"
                 class="ddp">
        </div>
    </div>
    <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
        <div class="my-3 py-3">
            ...
            <p class="lead">역사의 흔적을 품은 공원, 대구에서 가장 오래된 도심 공원.<br>
                사적 제 62호로 지정. 공원 안에 옛 토성과 지방문화재 자료 제3호인 관풍루가 자리하고 있다. 사슴과 타조, 물개, 호랑이 등을 관람할 수 있는 동물사가 있어 가족여행객에게
                인기.<br>
                곳곳에 벤치와 휴식 공간이 많으며 공원 둘레는 한바퀴 도는 오솔길이 조성되어 있어 천천히 산책하며 쉬어가기 좋다.</p>
        </div>
        <div>
            <img src="https://tour.daegu.go.kr/icms/tour/file/getImage.do?atchFileId=FILE_KOATTR_124%20%20%20%20%20&fileSn=3519"
                 class="door">
        </div>
    </div>
</div>
