...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
        ...
        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#jeju">
            Review
        </button>
    </div>
...
<div class="modal fade" id="jeju" tabindex="-1" aria-labelledby="jejuLabel" aria-hidden="true">
        ...
        <div class="modal-content" style="border-radius: 1rem;">
            ...
            <div class="modal-body">
                <div class="d-flex flex-wrap align-items-center w-100 mt-2">
                    <h6 class="reviews-text mb-0 me-3">5.0/5.0</h6>
